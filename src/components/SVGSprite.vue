<template>
  ...
  >
    <symbol id="add-task-button-icon" viewBox="0 0 22 22" fill="none">
      <rect
        x="10.0833"
        y="3.66663"
        width="1.83333"
    ...
    <symbol id="task-edit-mode-button-icon" viewBox="0 0 22 22" fill="none">
      <rect width="22" height="22" rx="4" fill="#D6E7FF" />
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
    ...
    <symbol id="task-view-mode-button-icon" viewBox="0 0 22 22" fill="none">
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M18.5325 7.22254C18.825 7.51504 18.825 7.98754 18.5325 8.28004L17.16 9.65254L14.3475 6.84004L15.72 5.46754C16.0125 5.17504 16.485 5.17504 16.7775 5.46754L18.5325 7.22254ZM5.25 18.75V15.9375L13.545 7.64254L16.3575 10.455L8.0625 18.75H5.25Z"
